...
<html>
    <head>
      ...
      <header>
        ...
        <button class="nombre_check">MANGUERAS</button>
        </div>
            ...
            <form class="form">
               ...
               <div class="group">
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Valvula cerrada precintada (marchamo)</span>
                 ...
                 <div class="radio-input">
                    <div class="info">
                        <span class="question">Cubierta de Manguera, Boquilla, y Llave en buen estado </span>
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Cubierta de Manguera No obstruido</span>
                   ...
                   <div class="radio-input">
                    <div class="info">
                        <span class="question">Señalizacion colocada en Buen Estado</span>
