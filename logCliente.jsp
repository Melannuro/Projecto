...
<html>
    ...
    <body>
        ...
        <div class="contenido">
            <div class="login">
                <div class="preguntas">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b2>Para ver las inspecciones realizadas en su empresa</b2> <br>
    ...
    if (request.getParameter("btngrabar") != null) {
        ...
        try {
            ...
            String querystring = "SELECT * FROM empresacliente WHERE correo_cli = ? AND contrasenia_cli = ?";
            ...
            String correocliente = res.getString(2);
            String empresa = res.getString(5);
            //correocliente
            request.getSession().setAttribute("Nombre", Nombre);
    request.getSession().setAttribute("Correo", correocliente);
