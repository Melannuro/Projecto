...
<html>
    <head>
      ...
      <header>
        ...
        <button class="nombre_check">HIDRANTE DE PATIO</button>
        </div>
        ...
        <div class="card">
            <form class="form">
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Hidrante en buenas condiciones, NO obstruido</span>
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Se encuentra gabinete con accesorios para hidrante</span>
