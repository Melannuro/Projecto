...
<html>
    ...
    <header>
        ...
        <button class="nombre_check">VALVULAS</button>
        </div>
        ...
        <div class="card">
            ...
            <form class="form">
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Temperatura de la ubicacion de valvula mayor a 4.4°C</span>
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Valvula asegurada con cadena o supervision </span>
                ...
                <div class="radio-input">
                    <div class="info">
                        <span class="question">Conexiones en buen estado</span>
